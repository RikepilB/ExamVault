...
|------|-------|----------|---------|
| Admin | configured via `.env` | configured via `.env` | System administration |
| Instructor | create in local dev database | set securely per environment | Course/exam management |
